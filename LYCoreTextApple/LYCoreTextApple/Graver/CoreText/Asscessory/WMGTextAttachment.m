...
+ (instancetype)textAttachmentWithContent:(id)contents type:(WMGAttachmentType)type size:(CGSize)size {
...
@implementation NSAttributedString (WMGTextAttachment)
    ...
    /*
     {
        ...
        "CTForegroundColor": [UIColor clearColor].CGColor,
